...
import { ReorderSuggestions } from '@/components/purchase-orders/reorder-suggestions'
...
export default function PurchaseOrdersPage() {
  ...
  return (
    <DashboardLayout>
      ...
      {/* Items at or below their minimum (counting stock on order), with "Run reorder check" */}
      <ReorderSuggestions onRan={fetchPurchaseOrders} />
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        {po.autoGenerated && <Badge variant="outline">Auto-drafted</Badge>}
                      </div>
                      <CardDescription>
